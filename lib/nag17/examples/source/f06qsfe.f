...
*     .. Executable Statements ..
   ...
   60                CONTINUE
                     ...
                     CALL F06QSF(SIDE,N,K1,K2,C,S,A,LDA)
                     ...
                     DO 100 I = 2, N
                        DO 80 J = 1, I - 1
                           IF (A(I,J).NE.RROGUE) THEN
                              ...
                              WRITE (NOUT,99993) 'QSF', SIDE, N, K1, K2,
     +                          LDA
                              WRITE (NOUT,99996)
                              PASS = .FALSE.
                              GO TO 420
...
*                       Take the Hermitian transpose of P.
  ...
  160                   CONTINUE
                     END IF
*
                     CALL F06QWF(SIDE,N,K1,K2,C,S,A,LDA)
*
*                    Check whether A has been changed below diagonal by
*                    F06QWF.
                     DO 200 I = 2, N
                        DO 180 J = 1, I - 1
                           IF (A(I,J).NE.RROGUE) THEN
                              WRITE (NOUT,99998) I, J
                              WRITE (NOUT,99993) 'QWF', SIDE, N, K1, K2,
     +                          LDA
                              WRITE (NOUT,99996)
                              PASS = .FALSE.
                              GO TO 420
...
*                    Compare with the saved arrays.
  ...
  420 IF (PASS) THEN
      ...
      STOP
*
99999 FORMAT (' F06QSF Example Program Results',/1X)
...
99990 FORMAT (' F06QSF Example Program ends OK')
99989 FORMAT (' F06QSF Example Program ends with ERRORS')
      END
