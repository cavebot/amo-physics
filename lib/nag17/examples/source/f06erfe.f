...
*
      STOP
*
99999 FORMAT (' F06ERF Example Program Results',//1X,'MAX. NO. OF PRIN',
...
*
*     SUBROUTINE  TDDOTI  IS THE CERTIFICATION MODULE FOR THE SPARSE
*     BASIC LINEAR ALGEBRA SUBROUTINE MODULE  F06ERF/DDOTI.
*
...
*
            W = DDOTI(NZ,X,INDX,Y)
*
*           --- TEST ARGUMENTS OF DDOTI THAT ARE NOT
*               SUPPOSED TO CHANGE.
*
...
*
  160 CONTINUE
      RETURN
*
99999 FORMAT (1X,'DDOTI  ALTERED NZ FOR TEST WITH NZ = ',I5,' AND THE ',
     +       'INDX TYPE NO. ',I5,'.  ALTERED VALUE OF NZ = ',I5)
99998 FORMAT (1X,'DDOTI  ALTERED ARRAY X FOR TEST WITH NZ = ',I5,' AND',
     +       ' THE INDX TYPE NO. ',I5)
99997 FORMAT (1X,'DDOTI  ALTERED ARRAY INDX FOR TEST WITH NZ = ',I5,
     +       ' AND THE INDX TYPE NO. ',I5)
99996 FORMAT (1X,'DDOTI  ALTERED ARRAY Y FOR TEST WITH NZ = ',I5,' AND',
     +       ' THE INDX TYPE NO. ',I5)
99995 FORMAT (1X,'DDOTI  OUTPUT W IS INACCURATE FOR TEST WITH NZ = ',I5,
     +       ' AND THE INDX TYPE NO. ',I5,/1X,'DDOTI HAS VALUE =',1P,
     +       D15.5,' TRUE VALUE =',1P,D15.5,' ERROR = ',1P,D12.1)
99994 FORMAT (/1X,'DDOTI  PASSED ALL TESTS.')
99993 FORMAT (/1X,'DDOTI  FAILED',I10,' TESTS.')
      END
...
*     BASIC LINEAR ALGEBRA SUBROUTINE MODULE  F06ETF/DAXPYI.
*
*     WRITTEN BY      ROGER G GRIMES
*                     APRIL 1987
*
...
*     .. External Subroutines ..
      EXTERNAL          F06DBF, F06DFF, F06EFF, F06FBF, GNINDX, DAXPYI
*     .. Intrinsic Functions ..
      INTRINSIC         ABS, COS, MAX, MIN, DBLE, SIN
*     .. Executable Statements ..
*
...
*
*              --- TEST ARGUMENTS OF DAXPYI THAT ARE NOT
*                  SUPPOSED TO CHANGE.
*
               IF (NZ.NE.NZTRUE) THEN
                  COUNT = COUNT + 1
...
*
  200 CONTINUE
      RETURN
*
99999 FORMAT (1X,'DAXPYI ALTERED NZ FOR TEST WITH NZ = ',I5,' A =',1P,
     +       D15.5,' AND THE INDX TYPE NO. ',I5,'.  ALTERED VALUE OF N',
     +       'Z = ',I5)
99998 FORMAT (1X,'DAXPYI ALTERED A FOR TEST WITH NZ = ',I5,' A =',1P,
     +       D15.5,' AND THE INDX TYPE NO. ',I5,'.  ALTERED VALUE OF A',
     +       ' =',1P,D15.5)
99997 FORMAT (1X,'DAXPYI ALTERED ARRAY X FOR TEST WITH NZ = ',I5,' A =',
     +       1P,D15.5,' AND THE INDX TYPE NO. ',I5)
99996 FORMAT (1X,'DAXPYI ALTERED ARRAY INDX FOR TEST WITH NZ = ',I5,
     +       ' A =',1P,D15.5,' AND THE INDX TYPE NO. ',I5)
99995 FORMAT (1X,'DAXPYI OUTPUT ARRAY Y IS INCORRECT FOR TEST WITH NZ ',
     +       '= ',I5,' A =',1P,D15.5,' AND THE INDX TYPE NO. ',I5,/1X,
     +       'INCORRECT COMPONENT NO. ',I5,' HAS VALUE =',1P,D15.5,' T',
     +       'RUE VALUE =',1P,D15.5)
99994 FORMAT (1X,'DAXPYI OUTPUT ARRAY Y IS INACCURATE FOR TEST WITH NZ',
     +       ' = ',I5,' A =',1P,D15.5,' AND THE INDX TYPE NO. ',I5,/1X,
     +       'INACCURATE COMPONENT NO. ',I5,' HAS VALUE =',1P,D15.5,
     +       ' TRUE VALUE =',1P,D15.5,' ERROR = ',1P,D12.1)
99993 FORMAT (/1X,'DAXPYI PASSED ALL TESTS.')
99992 FORMAT (/1X,'DAXPYI FAILED',I10,' TESTS.')
      END
      SUBROUTINE TSGTHR(NOUT,NZMAX2,NUMNZ,NZVALU,X,XSAVE,XTRUE,Y,YSAVE,
     +                  YTRUE,INDX,INDXT,ERRCNT,ERRMAX)
*
*     SUBROUTINE  TDGTHR  IS THE CERTIFICATION MODULE FOR THE SPARSE
*     BASIC LINEAR ALGEBRA SUBROUTINE MODULE  F06EUF/DGTHR.
*
*     WRITTEN BY      ROGER G GRIMES
*                     APRIL 1987
*
...
*     .. External Functions ..
      ...
      EXTERNAL          IVSAME, SVSAME
*     .. External Subroutines ..
      EXTERNAL          F06DFF, F06EFF, F06FBF, GNINDX, DGTHR
*     .. Intrinsic Functions ..
...
*
*           --- TEST ARGUMENTS OF DGTHR THAT ARE NOT
*               SUPPOSED TO CHANGE.
*
            IF (NZ.NE.NZTRUE) THEN
               COUNT = COUNT + 1
...
*
  160 CONTINUE
      RETURN
*
99999 FORMAT (1X,'DGTHR  ALTERED NZ FOR TEST WITH NZ = ',I5,' AND THE ',
     +       'INDX TYPE NO. ',I5,'.  ALTERED VALUE OF NZ = ',I5)
99998 FORMAT (1X,'DGTHR  ALTERED ARRAY Y FOR TEST WITH NZ = ',I5,' AND',
     +       ' THE INDX TYPE NO. ',I5)
99997 FORMAT (1X,'DGTHR  ALTERED ARRAY INDX FOR TEST WITH NZ = ',I5,
     +       ' AND THE INDX TYPE NO. ',I5)
99996 FORMAT (1X,'DGTHR  OUTPUT ARRAY X IS INCORRECT FOR TEST WITH NZ ',
     +       '= ',I5,' AND THE INDX TYPE NO. ',I5,/1X,'INACCURATE COMP',
     +       'ONENT NO. ',I5,' HAS VALUE =',1P,D15.5,' TRUE VALUE = ',
     +       1P,D15.5)
99995 FORMAT (/1X,'DGTHR  PASSED ALL TESTS.')
99994 FORMAT (/1X,'DGTHR  FAILED',I10,' TESTS.')
      END
...
*     BASIC LINEAR ALGEBRA SUBROUTINE MODULE  F06EVF/DGTHRZ.
*
*     WRITTEN BY      ROGER G GRIMES
*                     APRIL 1987
*
...
*     .. External Functions ..
      ...
      EXTERNAL          IVSAME
*     .. External Subroutines ..
      EXTERNAL          F06DFF, F06EFF, F06FBF, GNINDX, DGTHRZ
*     .. Intrinsic Functions ..
      INTRINSIC         COS, MAX, DBLE, SIN
*     .. Executable Statements ..
*
...
*
*           --- TEST ARGUMENTS OF DGTHRZ THAT ARE NOT
*               SUPPOSED TO CHANGE.
*
            IF (NZ.NE.NZTRUE) THEN
               COUNT = COUNT + 1
...
*
  160 CONTINUE
      RETURN
*
99999 FORMAT (1X,'DGTHRZ ALTERED NZ FOR TEST WITH NZ = ',I5,' AND THE ',
     +       'INDX TYPE NO. ',I5,'.  ALTERED VALUE OF NZ = ',I5)
99998 FORMAT (1X,'DGTHRZ ALTERED ARRAY INDX FOR TEST WITH NZ = ',I5,
     +       ' AND THE INDX TYPE NO. ',I5)
99997 FORMAT (1X,'DGTHRZ OUTPUT ARRAY X IS INCORRECT FOR TEST WITH NZ ',
     +       '= ',I5,' AND THE INDX TYPE NO. ',I5,/1X,'INACCURATE COMP',
     +       'ONENT NO. ',I5,' HAS VALUE =',1P,D15.5,' TRUE VALUE =',1P,
     +       D15.5)
99996 FORMAT (1X,'DGTHRZ OUTPUT ARRAY Y IS INCORRECT FOR TEST WITH NZ ',
     +       '= ',I5,' AND THE INDX TYPE NO. ',I5,/1X,'INACCURATE COMP',
     +       'ONENT NO. ',I5,' HAS VALUE =',1P,D15.5,' TRUE VALUE =',1P,
     +       D15.5)
99995 FORMAT (/1X,'DGTHRZ PASSED ALL TESTS.')
99994 FORMAT (/1X,'DGTHRZ FAILED',I10,' TESTS.')
      END
      SUBROUTINE TSSCTR(NOUT,NZMAX2,NUMNZ,NZVALU,X,XSAVE,XTRUE,Y,YSAVE,
     +                  YTRUE,INDX,INDXT,ERRCNT,ERRMAX)
*
*     SUBROUTINE  TDSCTR  IS THE CERTIFICATION MODULE FOR THE SPARSE
*     BASIC LINEAR ALGEBRA SUBROUTINE MODULE  F06EWF/DSCTR.
*
*     WRITTEN BY      ROGER G GRIMES
*                     APRIL 1987
*
...
*     .. External Functions ..
      ...
      EXTERNAL          IVSAME, SVSAME
*     .. External Subroutines ..
      EXTERNAL          F06DFF, F06EFF, F06FBF, GNINDX, DSCTR
*     .. Intrinsic Functions ..
...
*
*           --- TEST ARGUMENTS OF DSCTR THAT ARE NOT
*               SUPPOSED TO CHANGE.
*
            IF (NZ.NE.NZTRUE) THEN
               COUNT = COUNT + 1
...
*
  140 CONTINUE
      RETURN
*
99999 FORMAT (1X,'DSCTR  ALTERED NZ FOR TEST WITH NZ = ',I5,' AND THE ',
     +       'INDX TYPE NO. ',I5,'.  ALTERED VALUE OF NZ = ',I5)
99998 FORMAT (1X,'DSCTR  ALTERED ARRAY X FOR TEST WITH NZ = ',I5,' AND',
     +       ' THE INDX TYPE NO. ',I5)
99997 FORMAT (1X,'DSCTR  ALTERED ARRAY INDX FOR TEST WITH NZ = ',I5,
     +       ' AND THE INDX TYPE NO. ',I5)
99996 FORMAT (1X,'DSCTR  OUTPUT ARRAY Y IS INCORRECT FOR TEST WITH NZ ',
     +       '= ',I5,' AND THE INDX TYPE NO. ',I5,/1X,'INACCURATE COMP',
     +       'ONENT NO. ',I5,' HAS VALUE =',1P,D15.5,' TRUE VALUE =',1P,
     +       D15.5)
99995 FORMAT (/1X,'DSCTR  PASSED ALL TESTS.')
99994 FORMAT (/1X,'DSCTR  FAILED',I10,' TESTS.')
      END
...
*
*     SUBROUTINE  TDROTI  IS THE CERTIFICATION MODULE FOR THE SPARSE
*     BASIC LINEAR ALGEBRA SUBROUTINE MODULE  F06EXF/DROTI.
*
*     WRITTEN BY      ROGER G GRIMES
*                     APRIL 1987
*
...
*     .. External Functions ..
      ...
      EXTERNAL          IVSAME
*     .. External Subroutines ..
      EXTERNAL          F06DBF, F06DFF, F06EFF, F06FBF, GNINDX, DROTI
*     .. Intrinsic Functions ..
      INTRINSIC         ABS, COS, MAX, MIN, DBLE, SIN
*     .. Executable Statements ..
*
...
*
*              --- TEST ARGUMENTS OF DROTI THAT ARE NOT
*                  SUPPOSED TO CHANGE.
*
               IF (NZ.NE.NZTRUE) THEN
                  COUNT = COUNT + 1
...
*
  200 CONTINUE
      RETURN
*
99999 FORMAT (1X,'DROTI  ALTERED NZ FOR TEST WITH NZ = ',I5,' C, S = ',
     +       1P,2D15.5,' AND THE INDX TYPE NO. ',I5,/1X,'ALTERED VALUE',
     +       ' OF NZ = ',I5)
99998 FORMAT (1X,'DROTI  ALTERED C FOR TEST WITH NZ = ',I5,' C, S = ',
     +       1P,2D15.5,' AND THE INDX TYPE NO. ',I5,/1X,'ALTERED VALUE',
     +       ' OF C = ',1P,D15.5)
99997 FORMAT (1X,'DROTI  ALTERED S FOR TEST WITH NZ = ',I5,' C, S = ',
     +       1P,2D15.5,' AND THE INDX TYPE NO. ',I5,/1X,'ALTERED VALUE',
     +       ' OF S = ',1P,D15.5)
99996 FORMAT (1X,'DROTI  ALTERED ARRAY INDX FOR TEST WITH NZ = ',I5,
     +       ' C, S = ',1P,2D15.5,' AND THE INDX TYPE NO. ',I5)
99995 FORMAT (1X,'DROTI  OUTPUT ARRAY X IS INCORRECT FOR TEST WITH NZ ',
     +       '= ',I5,' C, S = ',1P,2D15.5,' AND THE INDX TYPE NO. ',I5,
     +       /1X,'INCORRECT COMPONENT NO. ',I5,' HAS VALUE = ',1P,D15.5,
     +       ' TRUE VALUE = ',1P,D15.5)
99994 FORMAT (1X,'DROTI  OUTPUT ARRAY Y IS INCORRECT FOR TEST WITH NZ ',
     +       '= ',I5,' C, S = ',1P,2D15.5,' AND THE INDX TYPE NO. ',I5,
     +       /1X,'INCORRECT COMPONENT NO. ',I5,' HAS VALUE = ',1P,D15.5,
     +       ' TRUE VALUE = ',1P,D15.5)
99993 FORMAT (1X,'DROTI  OUTPUT ARRAY X IS INACCURATE FOR TEST WITH NZ',
     +       ' = ',I5,' C, S = ',1P,2D15.5,' AND THE INDX TYPE NO. ',I5,
     +       /1X,'INACCURATE COMPONENT NO. ',I5,' HAS VALUE = ',1P,
     +       D15.5,' TRUE VALUE = ',1P,D15.5,' ERROR = ',1P,D12.1)
99992 FORMAT (1X,'DROTI  OUTPUT ARRAY Y IS INACCURATE FOR TEST WITH NZ',
     +       ' = ',I5,' C, S = ',1P,2D15.5,' AND THE INDX TYPE NO. ',I5,
     +       /1X,'INACCURATE COMPONENT NO. ',I5,' HAS VALUE = ',1P,
     +       D15.5,' TRUE VALUE = ',1P,D15.5,' ERROR = ',1P,D12.1)
99991 FORMAT (/1X,'DROTI  PASSED ALL TESTS.')
99990 FORMAT (/1X,'DROTI  FAILED',I10,' TESTS.')
      END
