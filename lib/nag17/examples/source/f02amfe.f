*     F02AMF Example Program Text
*     Mark 14 Revised.  NAG Copyright 1989.
*     .. Parameters ..
      INTEGER          NMAX, IZ, IA
      PARAMETER        (NMAX=8,IZ=NMAX,IA=NMAX)
      INTEGER          NIN, NOUT
...
*     .. Executable Statements ..
      WRITE (NOUT,*) 'F02AMF Example Program Results'
...
*     Eigenvalues and eigenvectors of original matrix
      CALL F02AMF(N,EPS,D,E,Z,IZ,IFAIL)
*
      IF (IFAIL.NE.0) THEN
         WRITE (NOUT,99999) 'Error in F02AMF. IFAIL =', IFAIL
      ELSE
