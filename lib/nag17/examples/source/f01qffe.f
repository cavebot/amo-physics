...
*     .. Local Arrays ..
      DOUBLE PRECISION A(LDA,NMAX), WORK(2*NMAX), ZETA(NMAX)
      INTEGER          PERM(NMAX)
...
*     .. Executable Statements ..
      WRITE (NOUT,*) 'F01QFF Example Program Results'
...
*        Find the QR factorization of A
         CALL F01QFF('Column interchanges',M,N,A,LDA,ZETA,PERM,WORK,
     +               IFAIL)
*
