 F06GTF Example Program Results
 ...
 F06GRF PASSED ALL TESTS.

 F06GSF PASSED ALL TESTS.

 F06GTF PASSED ALL TESTS.

 F06GUF PASSED ALL TESTS.

 F06GVF PASSED ALL TESTS.

 F06GWF PASSED ALL TESTS.
