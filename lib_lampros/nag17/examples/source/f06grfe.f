...
*
      STOP
*
99999 FORMAT (' F06GRF Example Program Results',//1X,'MAX. NO. OF PRIN',
...
*     BASIC LINEAR ALGEBRA SUBROUTINE MODULE  ZDOTUI.
*
...
*
*           --- TEST ARGUMENTS OF ZDOTUI THAT ARE NOT
*               SUPPOSED TO CHANGE.
*
...
*
  160 CONTINUE
      RETURN
*
99999 FORMAT (1X,'ZDOTUI ALTERED NZ FOR TEST WITH NZ = ',I5,' AND THE ',
     +       'INDX TYPE NO. ',I5,'.  ALTERED VALUE OF NZ = ',I5)
99998 FORMAT (1X,'ZDOTUI ALTERED ARRAY X FOR TEST WITH NZ = ',I5,' AND',
     +       ' THE INDX TYPE NO. ',I5)
99997 FORMAT (1X,'ZDOTUI ALTERED ARRAY INDX FOR TEST WITH NZ = ',I5,
     +       ' AND THE INDX TYPE NO. ',I5)
99996 FORMAT (1X,'ZDOTUI ALTERED ARRAY Y FOR TEST WITH NZ = ',I5,' AND',
     +       ' THE INDX TYPE NO. ',I5)
99995 FORMAT (1X,'ZDOTUI OUTPUT W IS INACCURATE FOR TEST WITH NZ = ',I5,
     +       ' AND THE INDX TYPE NO. ',I5,/1X,'ZDOTUI HAS VALUE = (',1P,
     +       D15.5,',',1P,D15.5,') TRUE VALUE = (',1P,D15.5,',',1P,
     +       D15.5,') ERROR = ',1P,D12.1)
99994 FORMAT (/1X,'ZDOTUI PASSED ALL TESTS.')
99993 FORMAT (/1X,'ZDOTUI FAILED',I10,' TESTS.')
      END
...
*     BASIC LINEAR ALGEBRA SUBROUTINE MODULE  ZDOTCI.
*
*     WRITTEN BY      ROGER G GRIMES
*                     APRIL 1987
*
...
*
*           --- TEST ARGUMENTS OF ZDOTCI THAT ARE NOT
*               SUPPOSED TO CHANGE.
*
            IF (NZ.NE.NZTRUE) THEN
               COUNT = COUNT + 1
...
*
  160 CONTINUE
      RETURN
*
99999 FORMAT (1X,'ZDOTCI ALTERED NZ FOR TEST WITH NZ = ',I5,' AND THE ',
     +       'INDX TYPE NO. ',I5,'.  ALTERED VALUE OF NZ = ',I5)
99998 FORMAT (1X,'ZDOTCI ALTERED ARRAY X FOR TEST WITH NZ = ',I5,' AND',
     +       ' THE INDX TYPE NO. ',I5)
99997 FORMAT (1X,'ZDOTCI ALTERED ARRAY INDX FOR TEST WITH NZ = ',I5,
     +       ' AND THE INDX TYPE NO. ',I5)
99996 FORMAT (1X,'ZDOTCI ALTERED ARRAY Y FOR TEST WITH NZ = ',I5,' AND',
     +       ' THE INDX TYPE NO. ',I5)
99995 FORMAT (1X,'ZDOTCI OUTPUT W IS INACCURATE FOR TEST WITH NZ = ',I5,
     +       ' AND THE INDX TYPE NO. ',I5,/1X,'ZDOTCI HAS VALUE = (',1P,
     +       D15.5,',',1P,D15.5,') TRUE VALUE = (',1P,D15.5,',',1P,
     +       D15.5,') ERROR = ',1P,D12.1)
99994 FORMAT (/1X,'ZDOTCI PASSED ALL TESTS.')
99993 FORMAT (/1X,'ZDOTCI FAILED',I10,' TESTS.')
      END
...
*     BASIC LINEAR ALGEBRA SUBROUTINE MODULE  ZAXPYI.
*
*     WRITTEN BY      ROGER G GRIMES
*                     APRIL 1987
*
...
*     .. External Subroutines ..
      EXTERNAL          ZAXPYI, F06DBF, F06DFF, F06GFF, F06HBF, GNINDX
*     .. Intrinsic Functions ..
      INTRINSIC         ABS, DCMPLX, COS, MAX, MIN, DBLE, SIN
*     .. Executable Statements ..
*
...
*
*              --- TEST ARGUMENTS OF ZAXPYI THAT ARE NOT
*                  SUPPOSED TO CHANGE.
*
               IF (NZ.NE.NZTRUE) THEN
                  COUNT = COUNT + 1
...
*
  200 CONTINUE
      RETURN
*
99999 FORMAT (1X,'ZAXPYI ALTERED NZ FOR TEST WITH NZ = ',I5,' A = (',1P,
     +       D15.5,',',1P,D15.5,') AND THE INDX TYPE NO. ',I5,/1X,'ALT',
     +       'ERED VALUE OF NZ = ',I5)
99998 FORMAT (1X,'ZAXPYI ALTERED A FOR TEST WITH NZ = ',I5,' A = (',1P,
     +       D15.5,',',1P,D15.5,') AND THE INDX TYPE NO. ',I5,/1X,'ALT',
     +       'ERED VALUE OF A = (',1P,D15.5,',',1P,D15.5,')')
99997 FORMAT (1X,'ZAXPYI ALTERED ARRAY X FOR TEST WITH NZ = ',I5,' A =',
     +       ' (',1P,D15.5,',',1P,D15.5,') AND THE INDX TYPE NO. ',I5)
99996 FORMAT (1X,'ZAXPYI ALTERED ARRAY INDX FOR TEST WITH NZ = ',I5,
     +       ' A = (',1P,D15.5,',',1P,D15.5,') AND THE INDX TYPE NO. ',
     +       I5)
99995 FORMAT (1X,'ZAXPYI OUTPUT ARRAY Y IS INCORRECT FOR TEST WITH NZ ',
     ...
     +       ',',1P,D15.5,')')
99994 FORMAT (1X,'ZAXPYI OUTPUT ARRAY Y IS INACCURATE FOR TEST WITH NZ',
...
99993 FORMAT (/1X,'ZAXPYI PASSED ALL TESTS.')
99992 FORMAT (/1X,'ZAXPYI FAILED',I10,' TESTS.')
      END
      SUBROUTINE TCGTHR(NOUT,NZMAX2,NUMNZ,NZVALU,X,XSAVE,XTRUE,Y,YSAVE,
     +                  YTRUE,INDX,INDXT,ERRCNT,ERRMAX)
*
*     SUBROUTINE  TZGTHR  IS THE CERTIFICATION MODULE FOR THE SPARSE
*     BASIC LINEAR ALGEBRA SUBROUTINE MODULE  ZGTHR.
*
*     WRITTEN BY      ROGER G GRIMES
*                     APRIL 1987
*
...
*     .. External Functions ..
      ...
      EXTERNAL          CVSAME, IVSAME
*     .. External Subroutines ..
      EXTERNAL          ZGTHR, F06DFF, F06GFF, F06HBF, GNINDX
*     .. Intrinsic Functions ..
...
*
*           --- TEST ARGUMENTS OF ZGTHR THAT ARE NOT
*               SUPPOSED TO CHANGE.
*
            IF (NZ.NE.NZTRUE) THEN
               COUNT = COUNT + 1
...
*
  160 CONTINUE
      RETURN
*
99999 FORMAT (1X,'ZGTHR  ALTERED NZ FOR TEST WITH NZ = ',I5,' AND THE ',
     +       'INDX TYPE NO. ',I5,'.  ALTERED VALUE OF NZ = ',I5)
99998 FORMAT (1X,'ZGTHR  ALTERED ARRAY Y FOR TEST WITH NZ = ',I5,' AND',
     +       ' THE INDX TYPE NO. ',I5)
99997 FORMAT (1X,'ZGTHR  ALTERED ARRAY INDX FOR TEST WITH NZ = ',I5,
     +       ' AND THE INDX TYPE NO. ',I5)
99996 FORMAT (1X,'ZGTHR  OUTPUT ARRAY X IS INCORRECT FOR TEST WITH NZ ',
     +       '= ',I5,' AND THE INDX TYPE NO. ',I5,/1X,'INACCURATE COMP',
     +       'ONENT NO. ',I5,' HAS VALUE = (',1P,D15.5,',',1P,D15.5,
     +       ') TRUE VALUE = (',1P,D15.5,',',1P,D15.5,')')
99995 FORMAT (/1X,'ZGTHR  PASSED ALL TESTS.')
99994 FORMAT (/1X,'ZGTHR  FAILED',I10,' TESTS.')
      END
...
*     BASIC LINEAR ALGEBRA SUBROUTINE MODULE  ZGTHRZ.
*
*     WRITTEN BY      ROGER G GRIMES
*                     APRIL 1987
*
...
*     .. External Functions ..
      ...
      EXTERNAL          IVSAME
*     .. External Subroutines ..
      EXTERNAL          ZGTHRZ, F06DFF, F06GFF, F06HBF, GNINDX
*     .. Intrinsic Functions ..
      INTRINSIC         DCMPLX, COS, MAX, DBLE, SIN
*     .. Executable Statements ..
*
...
*
*           --- TEST ARGUMENTS OF ZGTHRZ THAT ARE NOT
*               SUPPOSED TO CHANGE.
*
            IF (NZ.NE.NZTRUE) THEN
               COUNT = COUNT + 1
...
*
  ...
  160 CONTINUE
      RETURN
*
99999 FORMAT (1X,'ZGTHRZ ALTERED NZ FOR TEST WITH NZ = ',I5,' AND THE ',
     +       'INDX TYPE NO. ',I5,'.  ALTERED VALUE OF NZ = ',I5)
99998 FORMAT (1X,'ZGTHRZ ALTERED ARRAY INDX FOR TEST WITH NZ = ',I5,
     +       ' AND THE INDX TYPE NO. ',I5)
99997 FORMAT (1X,'ZGTHRZ OUTPUT ARRAY X IS INCORRECT FOR TEST WITH NZ ',
     +       '= ',I5,' AND THE INDX TYPE NO. ',I5,/1X,'INACCURATE COMP',
     +       'ONENT NO. ',I5,' HAS VALUE = (',1P,D15.5,',',1P,D15.5,
     +       ') TRUE VALUE = (',1P,D15.5,',',1P,D15.5,')')
99996 FORMAT (1X,'ZGTHRZ OUTPUT ARRAY Y IS INCORRECT FOR TEST WITH NZ ',
     +       '= ',I5,' AND THE INDX TYPE NO. ',I5,/1X,'INACCURATE COMP',
     +       'ONENT NO. ',I5,' HAS VALUE = (',1P,D15.5,',',1P,D15.5,
     +       ') TRUE VALUE = (',1P,D15.5,',',1P,D15.5,')')
99995 FORMAT (/1X,'ZGTHRZ PASSED ALL TESTS.')
99994 FORMAT (/1X,'ZGTHRZ FAILED',I10,' TESTS.')
      END
      SUBROUTINE TCSCTR(NOUT,NZMAX2,NUMNZ,NZVALU,X,XSAVE,XTRUE,Y,YSAVE,
     +                  YTRUE,INDX,INDXT,ERRCNT,ERRMAX)
*
*     SUBROUTINE  TZSCTR  IS THE CERTIFICATION MODULE FOR THE SPARSE
*     BASIC LINEAR ALGEBRA SUBROUTINE MODULE  ZSCTR.
*
*     WRITTEN BY      ROGER G GRIMES
*                     APRIL 1987
*
...
*     .. External Functions ..
      ...
      EXTERNAL          CVSAME, IVSAME
*     .. External Subroutines ..
      EXTERNAL          ZSCTR, F06DFF, F06GFF, F06HBF, GNINDX
*     .. Intrinsic Functions ..
...
*
*           --- TEST ARGUMENTS OF ZSCTR THAT ARE NOT
*               SUPPOSED TO CHANGE.
*
            IF (NZ.NE.NZTRUE) THEN
               COUNT = COUNT + 1
...
*
  140 CONTINUE
      RETURN
*
99999 FORMAT (1X,'ZSCTR  ALTERED NZ FOR TEST WITH NZ = ',I5,' AND THE ',
     +       'INDX TYPE NO. ',I5,'.  ALTERED VALUE OF NZ = ',I5)
99998 FORMAT (1X,'ZSCTR  ALTERED ARRAY X FOR TEST WITH NZ = ',I5,' AND',
     +       ' THE INDX TYPE NO. ',I5)
99997 FORMAT (1X,'ZSCTR  ALTERED ARRAY INDX FOR TEST WITH NZ = ',I5,
     +       ' AND THE INDX TYPE NO. ',I5)
99996 FORMAT (1X,'ZSCTR  OUTPUT ARRAY Y IS INCORRECT FOR TEST WITH NZ ',
     +       '= ',I5,' AND THE INDX TYPE NO. ',I5,/1X,'INACCURATE COMP',
     +       'ONENT NO. ',I5,' HAS VALUE = (',1P,D15.5,',',1P,D15.5,
     +       ') TRUE VALUE = (',1P,D15.5,',',1P,D15.5,')')
99995 FORMAT (/1X,'ZSCTR  PASSED ALL TESTS.')
99994 FORMAT (/1X,'ZSCTR  FAILED',I10,' TESTS.')
      END
