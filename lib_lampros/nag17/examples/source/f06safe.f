...
*
  ...
  100 READ (NIN,99984,END=160) SNAMET, LTESTT
      DO 120 I = 1, NSUBS
         IF (SNAMET.EQ.SNAMES(I)(8:13)) GO TO 140
  120 CONTINUE
...
*           Subprogram is not to be tested.
            WRITE (NOUT,99983) SNAMES(ISNUM) (8:13)
         ELSE
            SRNAMT = SNAMES(ISNUM)
*           Test error exits.
            IF (TSTERR) THEN
...
99979 FORMAT (' F06SAF Example Program Results',/1X)
      END
...
*     .. External Functions ..
      ...
      EXTERNAL         LCE, LCERES
*     .. External Subroutines ..
      EXTERNAL         ZGBMV, ZGEMV, CMAKE, CMVCH
*     .. Intrinsic Functions ..
      INTRINSIC        ABS, MAX, MIN
*     .. Common blocks ..
      COMMON           /INFOC/INFOT, NOUTC, OK, LERR
...
*
     ...
     +                               SNAME(8:13), TRANS, M, N, ALPHA,
     +                               LDA, INCX, BETA, INCY
                                 CALL ZGEMV(TRANS,M,N,ALPHA,AA,LDA,XX,
     +                                      INCX,BETA,YY,INCY)
                              ELSE IF (BANDED) THEN
                                 IF (TRACE) WRITE (NTRA,99995) NC,
     +                               SNAME(8:13), TRANS, M, N, KL, KU,
...
*
                              ...
                              DO 80 I = 1, NARGS
                                 ...
                                 IF ( .NOT. ISAME(I)) WRITE (NOUT,99998)
     +                               I
   80                         CONTINUE
                              IF ( .NOT. SAME) THEN
                                 FATAL = .TRUE.
...
*
      IF (ERRMAX.LT.THRESH) THEN
         WRITE (NOUT,99999) SNAME(8:13), NC
      ELSE
         WRITE (NOUT,99997) SNAME(8:13), NC, ERRMAX
      END IF
      GO TO 280
*
  260 CONTINUE
      WRITE (NOUT,99996) SNAME(8:13)
      IF (FULL) THEN
         WRITE (NOUT,99994) NC, SNAME(8:13), TRANS, M, N, ALPHA, LDA,
     +     INCX, BETA, INCY
      ELSE IF (BANDED) THEN
         WRITE (NOUT,99995) NC, SNAME(8:13), TRANS, M, N, KL, KU, ALPHA,
     +     LDA, INCX, BETA, INCY
      END IF
*
  280 CONTINUE
...
*     .. External Functions ..
      ...
      EXTERNAL         LCE, LCERES
*     .. External Subroutines ..
      EXTERNAL         ZHBMV, ZHEMV, ZHPMV, CMAKE, CMVCH
*     .. Intrinsic Functions ..
      INTRINSIC        ABS, MAX
*     .. Common blocks ..
      COMMON           /INFOC/INFOT, NOUTC, OK, LERR
...
*
     ...
     +                            SNAME(8:13), UPLO, N, ALPHA, LDA,
     +                            INCX, BETA, INCY
                              CALL ZHEMV(UPLO,N,ALPHA,AA,LDA,XX,INCX,
     +                                   BETA,YY,INCY)
                           ELSE IF (BANDED) THEN
                              IF (TRACE) WRITE (NTRA,99994) NC,
     +                            SNAME(8:13), UPLO, N, K, ALPHA, LDA,
     +                            INCX, BETA, INCY
                              CALL ZHBMV(UPLO,N,K,ALPHA,AA,LDA,XX,INCX,
     +                                   BETA,YY,INCY)
                           ELSE IF (PACKED) THEN
                              IF (TRACE) WRITE (NTRA,99995) NC,
     +                            SNAME(8:13), UPLO, N, ALPHA, INCX,
     +                            BETA, INCY
                              CALL ZHPMV(UPLO,N,ALPHA,AA,XX,INCX,BETA,
     +                                   YY,INCY)
                           END IF
*
*                          Check if error-exit was taken incorrectly.
...
*
  240 CONTINUE
      WRITE (NOUT,99996) SNAME(8:13)
      IF (FULL) THEN
         WRITE (NOUT,99993) NC, SNAME(8:13), UPLO, N, ALPHA, LDA, INCX,
     +     BETA, INCY
      ELSE IF (BANDED) THEN
         WRITE (NOUT,99994) NC, SNAME(8:13), UPLO, N, K, ALPHA, LDA,
     +     INCX, BETA, INCY
      ELSE IF (PACKED) THEN
         WRITE (NOUT,99995) NC, SNAME(8:13), UPLO, N, ALPHA, INCX, BETA,
     +     INCY
      END IF
*
  260 CONTINUE
...
*     .. External Functions ..
      ...
      EXTERNAL         LCE, LCERES
*     .. External Subroutines ..
      EXTERNAL         CMAKE, CMVCH, ZTBMV, ZTBSV, ZTPMV, ZTPSV, ZTRMV,
     +                 ZTRSV
*     .. Intrinsic Functions ..
      INTRINSIC        ABS, MAX
*     .. Common blocks ..
...
*
                        IF (SNAME(11:12).EQ.'MV') THEN
                           IF (FULL) THEN
                              IF (TRACE) WRITE (NTRA,99993) NC,
     +                            SNAME(8:13), UPLO, TRANS, DIAG, N,
     +                            LDA, INCX
                              CALL ZTRMV(UPLO,TRANS,DIAG,N,AA,LDA,XX,
     +                                   INCX)
                           ELSE IF (BANDED) THEN
                              IF (TRACE) WRITE (NTRA,99994) NC,
     +                            SNAME(8:13), UPLO, TRANS, DIAG, N, K,
     +                            LDA, INCX
                              CALL ZTBMV(UPLO,TRANS,DIAG,N,K,AA,LDA,XX,
     +                                   INCX)
                           ELSE IF (PACKED) THEN
                              IF (TRACE) WRITE (NTRA,99995) NC,
     +                            SNAME(8:13), UPLO, TRANS, DIAG, N,
     +                            INCX
                              CALL ZTPMV(UPLO,TRANS,DIAG,N,AA,XX,INCX)
                           END IF
     ...
     +                            SNAME(8:13), UPLO, TRANS, DIAG, N, K,
     +                            LDA, INCX
                              CALL ZTBSV(UPLO,TRANS,DIAG,N,K,AA,LDA,XX,
     +                                   INCX)
                           ELSE IF (PACKED) THEN
                              IF (TRACE) WRITE (NTRA,99995) NC,
     +                            SNAME(8:13), UPLO, TRANS, DIAG, N,
     +                            INCX
                              CALL ZTPSV(UPLO,TRANS,DIAG,N,AA,XX,INCX)
                           END IF
                        END IF
*
*                       Check if error-exit was taken incorrectly.
...
*
  240 CONTINUE
      WRITE (NOUT,99996) SNAME(8:13)
      IF (FULL) THEN
         WRITE (NOUT,99993) NC, SNAME(8:13), UPLO, TRANS, DIAG, N, LDA,
     +     INCX
      ELSE IF (BANDED) THEN
         WRITE (NOUT,99994) NC, SNAME(8:13), UPLO, TRANS, DIAG, N, K,
     +     LDA, INCX
      ELSE IF (PACKED) THEN
         WRITE (NOUT,99995) NC, SNAME(8:13), UPLO, TRANS, DIAG, N, INCX
      END IF
*
  260 CONTINUE
      RETURN
...
*     .. External Functions ..
      ...
      EXTERNAL         LCE, LCERES
*     .. External Subroutines ..
      EXTERNAL         ZGERC, ZGERU, CMAKE, CMVCH
*     .. Intrinsic Functions ..
...
*                    Call the subroutine.
*
                     IF (TRACE) WRITE (NTRA,99994) NC, SNAME(8:13), M,
...
*
  280 CONTINUE
      WRITE (NOUT,99996) SNAME(8:13)
      WRITE (NOUT,99994) NC, SNAME(8:13), M, N, ALPHA, INCX, INCY, LDA
*
  300 CONTINUE
      RETURN
*
...
*     .. External Functions ..
      ...
      EXTERNAL         LCE, LCERES
*     .. External Subroutines ..
      EXTERNAL         ZHER, ZHPR, CMAKE, CMVCH
*     .. Intrinsic Functions ..
...
*
                  IF (FULL) THEN
                     IF (TRACE) WRITE (NTRA,99993) NC, SNAME(8:13),
     +                   UPLO, N, RALPHA, INCX, LDA
                     CALL ZHER(UPLO,N,RALPHA,XX,INCX,AA,LDA)
                  ELSE IF (PACKED) THEN
                     IF (TRACE) WRITE (NTRA,99994) NC, SNAME(8:13),
     +                   UPLO, N, RALPHA, INCX
...
*
  240 CONTINUE
      WRITE (NOUT,99996) SNAME(8:13)
      IF (FULL) THEN
         WRITE (NOUT,99993) NC, SNAME(8:13), UPLO, N, RALPHA, INCX, LDA
      ELSE IF (PACKED) THEN
         WRITE (NOUT,99994) NC, SNAME(8:13), UPLO, N, RALPHA, INCX
      END IF
*
  260 CONTINUE
      RETURN
...
*     .. External Functions ..
      ...
      EXTERNAL         LCE, LCERES
*     .. External Subroutines ..
      EXTERNAL         ZHER2, ZHPR2, CMAKE, CMVCH
*     .. Intrinsic Functions ..
...
*
     ...
     +                      UPLO, N, ALPHA, INCX, INCY, LDA
                        CALL ZHER2(UPLO,N,ALPHA,XX,INCX,YY,INCY,AA,LDA)
                     ELSE IF (PACKED) THEN
                        IF (TRACE) WRITE (NTRA,99994) NC, SNAME(8:13),
...
*
  320 CONTINUE
      WRITE (NOUT,99996) SNAME(8:13)
      IF (FULL) THEN
         WRITE (NOUT,99993) NC, SNAME(8:13), UPLO, N, ALPHA, INCX, INCY,
     +     LDA
      ELSE IF (PACKED) THEN
         WRITE (NOUT,99994) NC, SNAME(8:13), UPLO, N, ALPHA, INCX, INCY
      END IF
*
  340 CONTINUE
      RETURN
...
*     .. External Subroutines ..
      EXTERNAL         ZGBMV, ZGEMV, ZGERC, ZGERU, ZHBMV, ZHEMV, ZHER,
     +                 ZHER2, CHKXER, ZHPMV, ZHPR, ZHPR2, ZTBMV, ZTBSV,
...
*
  360 IF (OK) THEN
         WRITE (NOUT,99999) SRNAMT(8:13)
      ELSE
         WRITE (NOUT,99998) SRNAMT(8:13)
      END IF
      RETURN
*
*
