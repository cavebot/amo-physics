...
*     .. Executable Statements ..
      WRITE (NOUT,*) 'F06YAF Example Program Results'
      READ (NIN,*)
      NOUTC = NOUT
      NTRA = NOUT
      REWI = .FALSE.
...
*
     ...
     +                         ALPHA, LDA, LDB, BETA, LDC
                           CALL DGEMM(TRANSA,TRANSB,M,N,K,ALPHA,AA,LDA,
     +                                BB,LDB,BETA,CC,LDC)
*
...
*
     ...
     +                      SIDE, UPLO, M, N, ALPHA, LDA, LDB, BETA, LDC
                        CALL DSYMM(SIDE,UPLO,M,N,ALPHA,AA,LDA,BB,LDB,
     +                             BETA,CC,LDC)
*
*                       Check if error-exit was taken incorrectly.
*
...
*     .. External Functions ..
      ...
      EXTERNAL         LSE, LSERES
*     .. External Subroutines ..
      EXTERNAL         SMAKE, SMMCH, DTRMM, DTRSM
*     .. Intrinsic Functions ..
      INTRINSIC        MAX
*     .. Common blocks ..
      COMMON           /INFOC/INFOT, NOUTC, OK, LERR
...
*
     ...
     +                      UPLO, TRANS, N, K, ALPHA, LDA, BETA, LDC
                        CALL DSYRK(UPLO,TRANS,N,K,ALPHA,AA,LDA,BETA,CC,
     +                             LDC)
*
*                       Check if error-exit was taken incorrectly.
*
...
*
  240 CONTINUE
      WRITE (NOUT,99996) SNAME(8:13)
      WRITE (NOUT,99994) NC, SNAME(8:13), UPLO, TRANS, N, K, ALPHA, LDA,
     +  BETA, LDC
*
  260 CONTINUE
      RETURN
...
*
     ...
     +                      LDC
                        CALL DSYR2K(UPLO,TRANS,N,K,ALPHA,AA,LDA,BB,LDB,
     +                              BETA,CC,LDC)
*
*                       Check if error-exit was taken incorrectly.
*
