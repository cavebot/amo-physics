...
*     .. Local Scalars ..
      ...
      LOGICAL          WANTQ
*     .. Local Arrays ..
      COMPLEX*16       A(LDA,NMAX), DUMMY(1), WORK(NMAX), Y(LDY)
      DOUBLE PRECISION D(NMAX), E(NMAX)
*     .. External Subroutines ..
      EXTERNAL         F02UWF
*     .. Executable Statements ..
      WRITE (NOUT,*) 'F02UWF Example Program Results'
...
*        Reduce A to bidiagonal form
         CALL F02UWF(N,A,LDA,D,E,NCOLY,Y,LDY,WANTQ,DUMMY,1,WORK,IFAIL)
*
