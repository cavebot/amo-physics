...
99979 FORMAT (' F06PAF Example Program Results',/1X)
      END
...
*     .. External Functions ..
      ...
      EXTERNAL         LSE, LSERES
*     .. External Subroutines ..
      EXTERNAL         DGBMV, DGEMV, SMAKE, SMVCH
*     .. Intrinsic Functions ..
      INTRINSIC        ABS, MAX, MIN
*     .. Common blocks ..
      COMMON           /INFOC/INFOT, NOUTC, OK, LERR
...
*
     ...
     +                               LDA, INCX, BETA, INCY
                                 CALL DGEMV(TRANS,M,N,ALPHA,AA,LDA,XX,
     +                                      INCX,BETA,YY,INCY)
                              ELSE IF (BANDED) THEN
...
*     .. External Functions ..
      ...
      EXTERNAL         LSE, LSERES
*     .. External Subroutines ..
      EXTERNAL         SMAKE, SMVCH, DSBMV, DSPMV, DSYMV
*     .. Intrinsic Functions ..
      INTRINSIC        ABS, MAX
*     .. Common blocks ..
      COMMON           /INFOC/INFOT, NOUTC, OK, LERR
...
*
     ...
     +                            INCX, BETA, INCY
                              CALL DSBMV(UPLO,N,K,ALPHA,AA,LDA,XX,INCX,
     +                                   BETA,YY,INCY)
                           ELSE IF (PACKED) THEN
                              IF (TRACE) WRITE (NTRA,99995) NC,
     +                            SNAME(8:13), UPLO, N, ALPHA, INCX,
     +                            BETA, INCY
                              CALL DSPMV(UPLO,N,ALPHA,AA,XX,INCX,BETA,
     +                                   YY,INCY)
                           END IF
*
*                          Check if error-exit was taken incorrectly.
...
*     .. External Functions ..
      ...
      EXTERNAL         LSE, LSERES
*     .. External Subroutines ..
      EXTERNAL         SMAKE, SMVCH, DTBMV, DTBSV, DTPMV, DTPSV, DTRMV,
     +                 DTRSV
*     .. Intrinsic Functions ..
      INTRINSIC        ABS, MAX
*     .. Common blocks ..
...
*
     ...
     +                            LDA, INCX
                              CALL DTBMV(UPLO,TRANS,DIAG,N,K,AA,LDA,XX,
     +                                   INCX)
                           ELSE IF (PACKED) THEN
                              IF (TRACE) WRITE (NTRA,99995) NC,
     +                            SNAME(8:13), UPLO, TRANS, DIAG, N,
     ...
     +                            SNAME(8:13), UPLO, TRANS, DIAG, N, K,
     +                            LDA, INCX
                              CALL DTBSV(UPLO,TRANS,DIAG,N,K,AA,LDA,XX,
     +                                   INCX)
                           ELSE IF (PACKED) THEN
                              IF (TRACE) WRITE (NTRA,99995) NC,
     +                            SNAME(8:13), UPLO, TRANS, DIAG, N,
...
*     .. External Functions ..
      ...
      EXTERNAL         LSE, LSERES
*     .. External Subroutines ..
      EXTERNAL         SMAKE, SMVCH, DSPR, DSYR
*     .. Intrinsic Functions ..
      INTRINSIC        ABS, MAX
*     .. Common blocks ..
      COMMON           /INFOC/INFOT, NOUTC, OK, LERR
...
*
  240 CONTINUE
      WRITE (NOUT,99996) SNAME(8:13)
      IF (FULL) THEN
         WRITE (NOUT,99993) NC, SNAME(8:13), UPLO, N, ALPHA, INCX, LDA
      ELSE IF (PACKED) THEN
         WRITE (NOUT,99994) NC, SNAME(8:13), UPLO, N, ALPHA, INCX
      END IF
*
  260 CONTINUE
      RETURN
...
*     .. External Functions ..
      ...
      EXTERNAL         LSE, LSERES
*     .. External Subroutines ..
      EXTERNAL         SMAKE, SMVCH, DSPR2, DSYR2
*     .. Intrinsic Functions ..
      INTRINSIC        ABS, MAX
*     .. Common blocks ..
      COMMON           /INFOC/INFOT, NOUTC, OK, LERR
