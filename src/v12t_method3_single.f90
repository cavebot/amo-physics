...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Calculate SI, DI thresholds
  ...
  write(*,*) "Method 3 single ionization: No first term + single ionization configurations only + 2e states > SIT"
  ...
  eevv = 0
       ...
       loop_configurations: do ic = 1, ic_max!sum from configuration 1 to max number of configurations, for the total  L
         ...
         if( ((e1 < 0) .and. (e2 < 0))  .or. ((e1 > 0) .and. (e2 > 0))  ) then
           cycle loop_configurations
         end if
         ...
         eevv = 0
         eevv1 = 0
         N2e:DO ie = nsi_l(l_int), ie_max   !SUM OVER N
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
WRITE(Hout_outfile, "(a,i1,a,i1,a,i1,a)") "v12t/method3_single/v12t_method3_single_", l_int, "_",l1_int, "_", l2_int, ".out"
OPEN(3, file = Hout_outfile, access = 'append')

write(3,'(i2,3E20.10)') num_cycles_int, (fl1l2l)
close(3)
