...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Calculate SI, DI thresholds
  ...
  write(*,*) "Method 3: No first term + double continuum configurations only + 2e states > 0"
  ...
  eevv = 0
       ...
       loop_configurations: do ic = 1, ic_max!sum from configuration 1 to max number of configurations, for the total  L
         ...
         eevv = 0
         eevv1 = 0
         N2e:DO ie = ndi_l(l_int), (ie_max)   !SUM OVER N
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
WRITE(Hout_outfile, "(a,i1,a,i1,a,i1,a)") "tout/v12t_method3_", l_int, "_",l1_int, "_", l2_int, ".out"
