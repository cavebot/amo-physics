...
!  write(*,*) "working l2 = ", l2_int
  ...
  write(*,*)
  write(*,*) "Method 5: minus sign correction + all states included (no Ground state) + first term"
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
WRITE(Hout_outfile, "(a,i1,a,i1,a,i1,a)") "v12t/method5/v12t_method5_", l_int, ".out"
