...
!!! intermediate continuum states
      ...
      loi = LINTERMEDIATE
      WRITE(*,*) '# csh2ph::   Reached here = ', LINTERMEDIATE

      CALL cxfin(NCFG,nhfi,lhfi,lli,nmini,nmxi,noli,isi,loi,lsi,ncsmxi,ntoti,ndi,idcsi)
      WRITE(*,*) '# csh2ph::   finished first cxfin with Lintermediate = ', LINTERMEDIATE
