...
C################################################################
      ...
      ELSE IF(mode=='ascii') THEN
         OPEN(n, file=outfile)
      ENDIF
      WRITE(*,'(a10,10x,a40,1X,a20)') '# hfile::','  opened file = '
     &, outfile
      RETURN
...
Cxxxxxxxxxxxxxxxxxxxxxx
      ...
      WRITE(*,'(a10,10x,a40,1X,a20)') '# cfile::','  opened file = '
     &, outfile
...
Cxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
      ...
      outfile = sdir//"/"//TRIM(ADJUSTL(sfile))
     &                  //TRIM(ADJUSTL(S1))
     &                  //TRIM(ADJUSTL(S2))
     &                  //TRIM(ADJUSTL(GAUGE))
     &                  // "."//sdir
      ...
      WRITE(*,'(a10,10x,a40,1X,a20)') '# dfile::','  opened file = '
     &, outfile
      RETURN
...
C#    Open binary file for storing Energies and coefficient data
C#######################################################################
      SUBROUTINE V12FILE(N, L)
      INTEGER                  L,N

      IF(L.GT.14) THEN

         WRITE(*,*) ' L MUST BE LESS THAN 14 . FOR L > 14',
     1       ' MODIFY SUBROUTINE V12FILE. EXITING...'
         STOP

      ELSE

         WRITE(*,*) 'V12 :: DATA FOR L = ', L

      ENDIF

      IF(L.EQ.0) OPEN(N,FILE='dat/v12-0.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.1) OPEN(N,FILE='dat/v12-1.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.2) OPEN(N,FILE='dat/v12-2.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.3) OPEN(N,FILE='dat/v12-3.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.4) OPEN(N,FILE='dat/v12-4.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.5) OPEN(N,FILE='dat/v12-5.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.6) OPEN(N,FILE='dat/v12-6.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.7) OPEN(N,FILE='dat/v12-7.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.8) OPEN(N,FILE='dat/v12-8.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.9) OPEN(N,FILE='dat/v12-9.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.10) OPEN(N,FILE='dat/v12-10.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.11) OPEN(N,FILE='dat/v12-11.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.12) OPEN(N,FILE='dat/v12-12.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.13) OPEN(N,FILE='dat/v12-13.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L.EQ.14) OPEN(N,FILE='dat/v12-14.dat',
     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      RETURN
      END
...
c$$$      SUBROUTINE DMX2EFILE(N, L, MODE)
c$$$
c$$$      IF(L.GT.14) THEN
c$$$
c$$$         WRITE(*,*) ' L MUST BE LESS THAN 14 . FOR L > 14',
c$$$     1       ' MODIFY SUBROUTINE DMX2EFILE. EXITING...'
c$$$         STOP
c$$$
c$$$      ELSE
c$$$
c$$$         WRITE(*,*) 'DMX2E :: DATA FOR L = ', L
c$$$
c$$$      ENDIF
c$$$
c$$$      IF(MODE.EQ.0) THEN
c$$$
c$$$         IF(L.EQ.0) OPEN(N,FILE='dat/dmx2e-01.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.1) OPEN(N,FILE='dat/dmx2e-12.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.2) OPEN(N,FILE='dat/dmx2e-23.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.3) OPEN(N,FILE='dat/dmx2e-34.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.4) OPEN(N,FILE='dat/dmx2e-45.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.5) OPEN(N,FILE='dat/dmx2e-56.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.6) OPEN(N,FILE='dat/dmx2e-67.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.7) OPEN(N,FILE='dat/dmx2e-78.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.8) OPEN(N,FILE='dat/dmx2e-89.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.9) OPEN(N,FILE='dat/dmx2e-910.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.10) OPEN(N,FILE='dat/dmx2e-1011.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.11) OPEN(N,FILE='dat/dmx2e-1112.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$      IF(L.EQ.12) OPEN(N,FILE='dat/dmx2e-1213.v.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$      IF(L.EQ.13) OPEN(N,FILE='dat/dmx2e-1314.v.dat',
c$$$     1     FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$      IF(L.EQ.14) OPEN(N,FILE='dat/dmx2e-1415.v.dat',
c$$$     1     FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$
c$$$      ELSE
c$$$
c$$$         IF(L.EQ.0) OPEN(N,FILE='dat/dmx2e-01.l.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.1) OPEN(N,FILE='dat/dmx2e-12.l.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.2) OPEN(N,FILE='dat/dmx2e-23.l.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.3) OPEN(N,FILE='dat/dmx2e-34.l.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.4) OPEN(N,FILE='dat/dmx2e-45.l.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.5) OPEN(N,FILE='dat/dmx2e-56.l.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.6) OPEN(N,FILE='dat/dmx2e-67.l.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.7) OPEN(N,FILE='dat/dmx2e-78.l.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.8) OPEN(N,FILE='dat/dmx2e-89.l.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$         IF(L.EQ.9) OPEN(N,FILE='dat/dmx2e-910.l.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$      IF(L.EQ.10) OPEN(N,FILE='dat/dmx2e-1011.l.dat',
c$$$     1        FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$      IF(L.EQ.11) OPEN(N,FILE='dat/dmx2e-1112.l.dat',
c$$$     1     FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$      IF(L.EQ.12) OPEN(N,FILE='dat/dmx2e-1213.l.dat',
c$$$     1     FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$      IF(L.EQ.13) OPEN(N,FILE='dat/dmx2e-1314.l.dat',
c$$$     1     FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$      IF(L.EQ.14) OPEN(N,FILE='dat/dmx2e-1415.l.dat',
c$$$     1     FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
c$$$
c$$$      ENDIF
c$$$
...
C#######################################################################
     ...
     1       ' MODIFY SUBROUTINE CS2PHFILE. EXITING...'
      ...
      IF(L1.EQ.0.AND.L2.EQ.0) OPEN(N,FILE='cs2ph/cs2ph-00.v.dat')
c     1    FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
      IF(L1.EQ.0.AND.L2.EQ.2) OPEN(N,FILE='cs2ph/cs2ph-02.v.dat')
c     1    FORM='UNFORMATTED',ACCESS='SEQUENTIAL')
