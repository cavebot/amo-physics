...
!  write(*,*) "working l2 = ", l2_int
  ...
  write(*,*)
  write(*,*) "Method 7b: Scaled to total energy + E>0 + Partial in L"
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
WRITE(Hout_outfile, "(a,i1,a,i1,a,i1,a)") "v12t/method7b/v12t_method7b_ground_", l_int, ".out"
OPEN(3, file = Hout_outfile, access = 'append')

write(3,'(i2,3E20.10)') num_cycles_int, (1 + fl1l2l/ht)
close(3)
