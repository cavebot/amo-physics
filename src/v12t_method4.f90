...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! Calculate SI, DI thresholds
  ...
  write(*,*)
  write(*,*) "Method 4: minus sign correction + Hamiltonian energy term"
...
!  DO ie = ndi_l(l_int), ie_max   !SUM OVER N
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
WRITE(Hout_outfile, "(a,i1,a,i1,a,i1,a)") "v12t/method4/v12t_method4_", l_int, "_",l1_int, "_", l2_int, ".out"
