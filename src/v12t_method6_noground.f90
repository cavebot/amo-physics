...
!  write(*,*) "working l2 = ", l2_int
  ...
  write(*,*)
  write(*,*) "Method 6: Correct sign + all states and configurations (excluding Ground State) + first term. Partial in L"
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
WRITE(Hout_outfile, "(a,i1,a,i1,a,i1,a)") "v12t/method6/v12t_method6_noground_", l_int, ".out"
