...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!calcualte angular distribution
       ...
       !allocate( work_A(1:8, 1:8, 1:4, 1:nof_points_angular, 1:nof_points_angular))
        ...
        write(rd2efilename,"(a)") "ad2e/ad2e_L_0.out"
        ...
        loop_n1: do i_n1 = 1, 60
          ...
          !comment here for sum over all l1,l2              if((ll1 .eq. l1_select) .and. (ll2 .eq. l2_select)) then
        ...
        !comment here for sum over all l1,l2              end if
